...
const CONFIG = {
    ...
    excludeDirs: ['node_modules', "app/build", "assets/pets/cirno/org_resources/", ".gradle", "gradle", ".androidide", '.git', 'dist', "webui", "plugin", "restored_project"],
    extensions: ['.js', ".java", '.json', '.ts', '.css', '.html', '.md', '.txt', '.vue']
};
